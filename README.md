...
2. OC是 x1 carbon 2017 在 monterey 12.4 系统 引导为 OC 的EFI文件,此版本EFI文件将作为常更新的版本，推荐使用。
   （OC is the EFI file for x1 carbon 2017 on Monterey 12.4 with OC bootloader，and will be updated after changing）
