...
myOCEFI是 x1 carbon 2017 在 big sur 11.3 beta 系统 引导为OC 0.6.7 的EFI文件,此版本EFI文件将作为常更新的版本
（myOCEFI is the EFI file for x1 carbon 2017 on big sur 11.3 beta with OC bootloader 0.6.7，and will be updated after changing）
